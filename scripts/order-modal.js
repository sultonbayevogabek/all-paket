...
export default function orderModal() {
    ...
    // orderFormSubmit.addEventListener('click', async () => {
    //     let customerName = customerNameInput.value.trim().toLocaleLowerCase(),
    //         customerPhone = customerPhoneInput.value.replace(/\D/gi, '')
    //
