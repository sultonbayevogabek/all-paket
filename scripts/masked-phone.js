export default function maskedPhone() {
    ...
    (function (a) {
        a.MaskedInput = function (f) {
            ...
            let o = this, d = f.elm, s = f.format, i = f.allowed || "0123456789", h = f.allowedfx || function () {
                    return true
                ...
                t = s, j = (function () {
                    ...
                    for (let B = d.value.length - 1; B >= 0; B--) {
